    ...
    <div class="relative  bg-blueGray-100">
      ...
      <div class="relative bg-pink-600 md:pt-32 pb-32 pt-12">
        <div class="px-4 md:px-10 mx-auto w-full">
          ...
          <div class="relative  bg-blueGray-100">
              <div class="px-4 md:px-10 mx-auto w-full">
                <h1 class="text-3xl text-white font-semibold mb-4">Selamat Datang, {{ loggedInUser.name }}</h1>
                <div>
...
const fetchDataUser = async () => {
  try {
   ...
   // const response = await axios.get(`${import.meta.env.VITE_APP_API_URL}/${usersLogin}`)
